...
function pageLoad() {
    ...
    const autoScrollEnabled = localStorage.getItem('stackanswer-autoscroll-enabled') === 'true' || localStorage.getItem('stackanswer-autoscroll-enabled') === null || localStorage.getItem('stackanswer-autoscroll-enabled') === '';
